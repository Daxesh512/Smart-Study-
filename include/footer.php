    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4">
        ...
        <div class="d-flex flex-column gap-2 mb-3">
          <a href="https://www.linkedin.com/in/daxesh-patel-257061206" target="_blank" class="footer-link text-white text-decoration-none">
            <i class="bi bi-linkedin me-2"></i> LinkedIn
          </a>
          <a href="mailto:daxeshpatel5120@gmail.com" class="footer-link text-white text-decoration-none">
            <i class="bi bi-envelope-fill me-2"></i> daxeshpatel5120@gmail.com
          </a>
          <a href="tel:+91" class="footer-link text-white text-decoration-none">
            <i class="bi bi-telephone-fill me-2"></i> +91 
          </a>
           <a  class="footer-link text-white text-decoration-none">
            <i class="bi bi-geo-alt-fill me-1"></i> Navsari, Gujarat
          </a>
        </div>         
      </div>
    ...
    <div class="col-12 col-md-6 order-md-2 text-center text-md-end">
      <p class="small text-white-50 mb-0">
        ...
        <i class="bi bi-heart-fill text-danger"></i> by 
         <a href="https://www.linkedin.com/in/daxesh-patel-257061206" 
   target="_blank" 
